...
func (m *mockAgentContext) AgentName() string                    { return "test-agent-name" }
func (m *mockAgentContext) ReadonlyState() session.ReadonlyState { return nil }
func (m *mockAgentContext) UserID() string                       { return "test-user-id" }
func (m *mockAgentContext) AppName() string                      { return "test-app-name" }
func (m *mockAgentContext) SessionID() string                    { return "test-session-id" }
func (m *mockAgentContext) Branch() string                       { return "test-branch" }
...
func (m *mockToolContext) FunctionCallID() string         { return "mock-func-id" }
func (m *mockToolContext) Actions() *session.EventActions { return nil }
func (m *mockToolContext) AgentName() string              { return "mock-agent" }
